...
def generate_anchors(stride=16, sizes=(32, 64, 128, 256, 512), aspect_ratios=(0.5, 1, 2)):
    ...
    """
    return _generate_anchors(stride, np.array(sizes, dtype=np.float) / stride,
...
def make_anchor_generator(anchor_sizes, aspect_ratios, anchor_strides, straddle_thresh,
                          octave, scales_per_octave):
